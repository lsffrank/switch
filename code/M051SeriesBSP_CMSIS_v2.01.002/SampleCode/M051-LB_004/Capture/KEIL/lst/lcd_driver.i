#line 1 "..\\..\\..\\..\\LibM051Series\\M051-LB_004_Driver\\src\\LCD_Driver.c"
...
#line 13 "..\\..\\..\\..\\LibM051Series\\M051-LB_004_Driver\\src\\LCD_Driver.c"
...
#line 14 "..\\..\\..\\..\\LibM051Series\\M051-LB_004_Driver\\src\\LCD_Driver.c"
...
void LCD_Init(void)
{
    ...
    SPI = ((SPI_T *) ((( uint32_t)0x40000000) + 0x30000));
...
{
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x20*(1))) + ((1)<<2)))) = 0;
}
void LCD_DisableBackLight(void)
{
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x20*(1))) + ((1)<<2)))) = 1;
}
